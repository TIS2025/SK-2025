...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 5756.222641340639; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -5989.263551541574; // x position of the perpendicular encoder (in tick units)
    }
